 ...
 * Logging functions
 *
 * Module for initialising Windsor-Logging. With this Module it is possible to save informations in the log-file. To use
 * it in other modules
 *
 * <pre>
...
function log(message, level, indicator) {
  ...
  if (process.env.NODE_ENV === 'production') {
    ...
    require('util').log('\u001b['+levelColor+'m' + level + ' \u001b[' + indicatorColor + 'm' + indicator + ' \u001b[' + messageColor + 'm' + message + '\u001b[0m');
  }
}
exports.log = log;
